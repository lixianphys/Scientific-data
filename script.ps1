...
python toybands/addband.py 1e15 -gfactor 6 -cp 0.2 -1
python toybands/run.py -simu -loadden density4band.csv -fnm simu_noparity --enrange -0.05 0.1 50 --bfrange 1 7 240  -nmax 10
python toybands/run.py -simu -loadden density4band.csv -fnm simu_wparity --enrange -0.05 0.1 50 --bfrange 1 7 240  -nmax 10 -parity
