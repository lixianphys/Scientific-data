...
python toybands/addband.py 2e15 -is_dirac -is_cond -gfactor 1.8 -dp 8.5e6 5.2
python toybands/addband.py 5e15 -is_dirac -is_cond -gfactor 1.8 -dp 8.5e6 5.2
python toybands/addband.py 1e15 -gfactor 6 -cp 0.2 -1
python toybands/run.py -simu -loadden density.csv -fnm threeband_cal --enrange -0.05 0.1 50 --bfrange 1 7 480  -nmax 10 -parity
...
# python toybands/run.py -simu -loadden density4band.csv -fnm wparity --enrange -0.05 0.1 50 --bfrange 1 7 240  -nmax 10 -parity
